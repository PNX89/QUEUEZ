...
def _resolves(claim: str) -> bool:
    ...
    `queuez/thing.py` because that is the import path a reader types, and the file is at
    `src/queuez/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
