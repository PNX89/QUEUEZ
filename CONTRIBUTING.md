...
```bash
git clone https://github.com/PNX89/QUEUEZ.git && cd QUEUEZ
...
- the same rules against a real PostgreSQL
- the same normalisation, written twice
- a stampede, and a default that stops it being a cache
...
https://pnx89.github.io/QUEUEZ, come from a real run whose output is committed under
